...
var $author$project$Four$Four = F4(
	function (zero, one, two, three) {
		return {one: one, three: three, two: two, zero: zero};
	});
...
var $author$project$Main$removeColoring = F2(
	function (model, color) {
		var new_colors = A2($turboMaCk$any_dict$Dict$Any$remove, color, model.colors);
		var new_colorings = A2(
			$turboMaCk$any_dict$Dict$Any$map,
			function (_v0) {
				return $Gizra$elm_all_set$EverySet$remove(color);
			},
			model.colorings);
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.a.$) {
				case 'AddColor':
					var _v1 = _v0.a;
					var used_colors = $Gizra$elm_all_set$EverySet$fromList(
						$turboMaCk$any_dict$Dict$Any$keys(model.colors));
					var total_colors = $Gizra$elm_all_set$EverySet$fromList($author$project$Main$enumColors);
					var available_colors = $Gizra$elm_all_set$EverySet$toList(
						A2($Gizra$elm_all_set$EverySet$diff, total_colors, used_colors));
					var _v2 = $elm$core$List$head(available_colors);
					if (_v2.$ === 'Just') {
						var color = _v2.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									colors: A3($turboMaCk$any_dict$Dict$Any$insert, color, $Gizra$elm_all_set$EverySet$empty, model.colors),
									state: $author$project$Main$Marking(color)
								}),
...
var $author$project$Main$addColorButtonStyle = _List_fromArray(
	[
		$elm$html$Html$Events$onClick($author$project$Main$AddColor),
		$elm$html$Html$Attributes$class('add-color'),
		$elm$html$Html$Attributes$class('coloring-button')
	]);
...
var $author$project$Main$try = F2(
	function (pred, a) {
		return pred ? $elm$core$Maybe$Just(a) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$addColorButton = function (model) {
	return A2(
		$author$project$Main$try,
		_Utils_cmp(
			$turboMaCk$any_dict$Dict$Any$size(model.colors),
			$elm$core$List$length($author$project$Main$enumColors)) < 0,
		A2(
			$elm$html$Html$button,
			$author$project$Main$addColorButtonStyle,
			_List_fromArray(
				[
					$elm$html$Html$text('Add Cover')
				])));
};
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$FinishColoring = {$: 'FinishColoring'};
var $author$project$Main$finishColoringButtonStyle = _List_fromArray(
	[
		$elm$html$Html$Events$onClick($author$project$Main$FinishColoring),
		$elm$html$Html$Attributes$class('finish-coloring-color'),
		$elm$html$Html$Attributes$class('coloring-button')
	]);
var $author$project$Main$finishColoringButton = function (model) {
	var _v0 = model.state;
	if (_v0.$ === 'Marking') {
		return $elm$core$Maybe$Just(
			A2(
				$elm$html$Html$button,
				$author$project$Main$finishColoringButtonStyle,
				_List_fromArray(
					[
						$elm$html$Html$text('Finish Selection')
					])));
	} else {
		return $elm$core$Maybe$Nothing;
	}
...
var $author$project$Main$RemoveColor = {$: 'RemoveColor'};
var $author$project$Main$removeColorButtonStyle = _List_fromArray(
	[
		$elm$html$Html$Events$onClick($author$project$Main$RemoveColor),
		$elm$html$Html$Attributes$class('remove-color'),
		$elm$html$Html$Attributes$class('coloring-button')
	]);
var $author$project$Main$removeColorButton = function (model) {
	var _v0 = model.state;
	if (_v0.$ === 'Marking') {
		return A2(
			$author$project$Main$try,
			$turboMaCk$any_dict$Dict$Any$size(model.colors) >= 1,
			A2(
				$elm$html$Html$button,
				$author$project$Main$removeColorButtonStyle,
				_List_fromArray(
					[
						$elm$html$Html$text('Remove Color')
					])));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Main$tryAppend = F2(
	function (ma, l) {
		if (ma.$ === 'Just') {
			var a = ma.a;
...
var $author$project$Main$SelectColor = function (a) {
	return {$: 'SelectColor', a: a};
};
var $author$project$Main$columnValues = A4($author$project$Four$Four, '10', '11', '01', '00');
var $author$project$Four$get = F2(
	function (index, four) {
		switch (index.$) {
			case 'Zero':
				return four.zero;
...
var $author$project$Main$rowValues = A4($author$project$Four$Four, '00', '01', '11', '10');
var $author$project$Main$entryToString = F2(
	function (x, y) {
		return _Utils_ap(
			A2($author$project$Four$get, x, $author$project$Main$rowValues),
			A2($author$project$Four$get, y, $author$project$Main$columnValues));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Main$SelectColor(color)),
					A2(
					$elm$html$Html$Attributes$style,
					'border-color',
					$author$project$Main$colorName(color))
				]),
					...
					A2(
						...
						A2(
							...
							function (_v0) {
								var x = _v0.a;
								var y = _v0.b;
								return A2($author$project$Main$entryToString, x, y);
							},
							$Gizra$elm_all_set$EverySet$toList(selection))))));
	});
var $author$project$Main$viewColoring = F2(
			...
			A2(
				...
				A2(
					...
					function (_v0) {
						...
						return _Utils_Tuple2(
							c,
							A2($author$project$Main$viewSelection, c, selection));
					},
...
var $author$project$Main$rowCaption = function (variables) {
	return A2(
		...
		function (l) {
			return A2(
				$elm$core$List$cons,
				$author$project$Main$tableCaption(variables),
				l);
		}(
			$author$project$Four$toList(
				A2(
					...
					A2($author$project$Four$map, $elm$html$Html$text, $author$project$Main$rowValues)))));
};
var $elm$html$Html$table = _VirtualDom_node('table');
var $author$project$Main$columnCaption = function (index) {
	return $elm$html$Html$text(
		A2($author$project$Four$get, index, $author$project$Main$columnValues));
};
var $author$project$Main$ClickKarnaugh = F2(
	function (a, b) {
		return {$: 'ClickKarnaugh', a: a, b: b};
	});
var $author$project$Main$activeColoringFrameStyle = _List_fromArray(
	[
...
var $author$project$Main$coloringFrameStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'padding', '2px'),
		A2($elm$html$Html$Attributes$style, 'margin', '2px ')
	]);
var $author$project$Main$deactiveColoringFrameStyle = _List_fromArray(
	[
	...
	function (color, inner) {
		return function (attr) {
			...
			A2(
				...
				$author$project$Main$coloringFrameStyle,
				A2(
					$elm$core$Maybe$withDefault,
					$author$project$Main$deactiveColoringFrameStyle,
					A2(
						$elm$core$Maybe$map,
						$elm$core$List$append($author$project$Main$activeColoringFrameStyle),
						A2(
							$elm$core$Maybe$map,
							$elm$core$List$singleton,
							A2(
								$elm$core$Maybe$map,
								$elm$html$Html$Attributes$style('border-color'),
								A2($elm$core$Maybe$map, $author$project$Main$colorName, color)))))));
	});
...
var $author$project$Main$chooseColoring = F3(
	function (model, x, y) {
		...
		return A2(
			$elm$core$List$map,
			function (color) {
				return A2($Gizra$elm_all_set$EverySet$member, color, colors) ? $elm$core$Maybe$Just(color) : $elm$core$Maybe$Nothing;
			},
			$author$project$Main$enumColors);
	});
var $author$project$Main$fromBool = function (b) {
	return b ? '1' : '0';
};
var $author$project$Four$get2d = F3(
	function (x, y, array) {
		return A2(
			$author$project$Four$get,
			y,
			A2($author$project$Four$get, x, array));
	});
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$Main$viewDatum = F3(
	function (model, x, y) {
		return A2(
			$elm$html$Html$td,
			_List_Nil,
			_List_fromArray(
				[
					function (t) {
					return A2(
						$author$project$Main$applyColoring,
						t,
						A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									A2($author$project$Main$ClickKarnaugh, x, y))
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Main$fromBool(
										A3($author$project$Four$get2d, x, y, model.karnaugh)))
								])));
				}(
					A3($author$project$Main$chooseColoring, model, x, y))
				]));
	});
var $author$project$Main$viewRow = F2(
	function (model, x) {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Main$columnCaption(x),
				A2(
					$elm$core$List$map,
					A2($author$project$Main$viewDatum, model, x),
					$author$project$Four$enumFour)));
	});
var $author$project$Main$viewKarnaugh = F2(
	function (variables, model) {
		return A2(
			...
			function (l) {
				return A2(
					$elm$core$List$cons,
					$author$project$Main$rowCaption(variables),
					l);
			}(
				A2(
					$elm$core$List$map,
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		A3(
			$elm$core$List$foldr,
			$author$project$Main$tryAppend,
			_List_Nil,
			_List_fromArray(
				[
					$elm$core$Maybe$Just(
					A2($author$project$Main$viewKarnaugh, model.variables, model)),
					$elm$core$Maybe$Just(
					A2($author$project$Main$viewColoring, index, model.colors)),
					$author$project$Main$addColorButton(model),
					$author$project$Main$removeColorButton(model),
					$author$project$Main$finishColoringButton(model)
				])));
};
			...
			return A2(
				...
				function (error_redirect) {
					return $elm$json$Json$Decode$succeed(
						{error_redirect: error_redirect, karnaugh: karnaugh});
				},
				A2($elm$json$Json$Decode$field, 'error_redirect', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'karnaugh', $elm$json$Json$Decode$value)))(0)}});}(this));